...
// Feature flag: Jos dio luz verde 2026-09-25 para activar en stage/dev
// (presentacion en junta). Cambiar a true si hay que ocultar de nuevo.
const PRUEBA_COLOR_OCULTA = false;
